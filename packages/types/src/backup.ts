...
type BackupRefinementInput = Pick<
  BackupFlags,
  "format" | "compress" | "dataOnly" | "schemaOnly" | "clean" | "ifExists" | "jobs"
>;

export function applyBackupRefinements<T extends z.ZodType<BackupRefinementInput>>(
  schema: T,
): T {
  return schema
    .refine(
...
export const backupSchema = applyBackupRefinements(backupBaseSchema);
